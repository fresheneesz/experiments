...
:: Android packaging
set AND_CERT_NAME="testProject"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\testProject.p12
...
set IOS_PROVISION=cert\testProject.mobileprovision
...
set APP_ID=air.testProject

:: Output packages
set DIST_PATH=dist
set DIST_NAME=testProject
