...
:: Android packaging
set AND_CERT_NAME="Gestures"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Gestures.p12
...
set IOS_PROVISION=cert\Gestures.mobileprovision
...
set APP_ID=air.Gestures

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Gestures
