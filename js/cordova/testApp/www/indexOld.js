require(['jquery', 'proto', 'touch.amd.min', /*'phantomLimb',*/ 'jquery-transit', 'jquery.easing', 'zepto'], function($, proto, touch, phantomLimb) {
    //phantomLimb.start()
    ...
    $(function() {
        ...
        var firstPage = View({
            ...
            setup: function() {
                ...
                var sideBar = div().css({width: '20%', height: '100%', position: 'absolute', backgroundColor: 'red'})
                touch(sideBar, 'start', function(e) {
    ...
    function slideAction(currentView, nextView) {
        ...
        */
        ...
        Zepto(nextView.element[0]).animate({
            left: "0"
        }, 500, 'ease', function() {
            nextView.on()
            currentView.hide()
