require(['jquery', 'proto', /*'touch.amd.min', 'phantomLimb', */'TweenMax.min', 'jquery.gsap.min','jquery-transit', 'jquery.easing', 'zepto'], function($, proto, touch, phantomLimb) {
    //phantomLimb.start()
...
if(!_runningOnBrowser_) {
    document.addEventListener('deviceready', function() {
        cordova.exec(function(winParam) {
            console.log("Sucesssss: ")
            console.dir(winParam)
        }, function(error) {
