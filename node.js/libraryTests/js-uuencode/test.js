var uuencode = require('js-uuencode/lib/uuencode')
var fs = require ('fs');

var inFile = './file.txt';

console.log(convert_uuencode(fs.readFileSync(inFile).toString()))
...
// from https://github.com/kvz/phpjs/blob/master/functions/strings/convert_uuencode.js
// removed checks that return false
